    ...
    return(
        <div className='container'>
            ...
            <Card.Img src={WineImg} alt="Card image" />
                <Card.ImgOverlay>
                    <Card.Title style={{fontSize:'3.5rem'}}>WINE</Card.Title>
                            ...
                            <Tab.Content style={{color:'white'}}>
                                <Tab.Pane eventKey="first">
                                    ...
                                    <div className='tap-content' style={{fontSize:'1.1rem'}}>
                                        ...
                                        일단 Wine(와인)하면 우리나라의 대부분 사람들은 '포도를 이용해서 만든 술'로 생각합니다.
                                        정확히 우리나라의 와인은 1차 적으로 포도주를 뜻하지만, 과실주 전반을 뜻하는 말로 확장되어 쓰입니다.
                                        </p>                                       
                                        <p style={{marginTop:'50px'}}>
                                        와인의 기준은 나라마다 다르며 곡물로 만든 한국의 청주나 막걸리,동동주 중국의 황주, 일본의 사케까지 외국에서
                                        rice wine이라고 부르는 경우도 있을 정도로 와인의 범주는 다양합니다.
                                        </p>
                                        <p style={{marginTop:'50px'}}>
